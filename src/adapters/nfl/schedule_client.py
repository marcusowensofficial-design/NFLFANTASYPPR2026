...
class NFLScheduleClient:
    ...
    def _get_fallback_schedule(self, week: int = 2) -> list[NFLGame]:
        ...
        if week == 1:
            ...
            return [
                NFLGame(id="401872932", name="Detroit Lions at Buffalo Bills", date="2026-09-18T00:15Z", venue_name="Highmark Stadium", is_dome=False, home_team="BUF", away_team="DET", over_under=54.5, spread=-4.5, home_implied_total=29.5, away_implied_total=25.0),
                ...
                NFLGame(id="401872937", name="Minnesota Vikings at Chicago Bears", date="2026-09-20T17:00Z", venue_name="Soldier Field", is_dome=False, home_team="CHI", away_team="MIN", over_under=48.5, spread=-4.5, home_implied_total=26.5, away_implied_total=22.0),
                NFLGame(id="401872939", name="Philadelphia Eagles at Tennessee Titans", date="2026-09-20T17:00Z", venue_name="Nissan Stadium", is_dome=False, home_team="TEN", away_team="PHI", over_under=39.5, spread=7.0, home_implied_total=16.25, away_implied_total=23.25),
                NFLGame(id="401872946", name="Pittsburgh Steelers at New England Patriots", date="2026-09-20T17:00Z", venue_name="Gillette Stadium", is_dome=False, home_team="NE", away_team="PIT", over_under=41.5, spread=-5.5, home_implied_total=23.5, away_implied_total=18.0),
                NFLGame(id="401872936", name="Green Bay Packers at New York Jets", date="2026-09-20T17:00Z", venue_name="MetLife Stadium", is_dome=False, home_team="NYJ", away_team="GB", over_under=44.5, spread=3.5, home_implied_total=20.5, away_implied_total=24.0),
                NFLGame(id="401872935", name="Cleveland Browns at Tampa Bay Buccaneers", date="2026-09-20T17:00Z", venue_name="Raymond James Stadium", is_dome=False, home_team="TB", away_team="CLE", over_under=41.5, spread=-8.5, home_implied_total=25.0, away_implied_total=16.5),
                NFLGame(id="401872938", name="New Orleans Saints at Baltimore Ravens", date="2026-09-20T17:00Z", venue_name="M&T Bank Stadium", is_dome=False, home_team="BAL", away_team="NO", over_under=46.5, spread=-8.5, home_implied_total=27.5, away_implied_total=19.0),
                NFLGame(id="401872934", name="Cincinnati Bengals at Houston Texans", date="2026-09-20T17:00Z", venue_name="Reliant Stadium", is_dome=True, home_team="HOU", away_team="CIN", over_under=46.5, spread=-3.0, home_implied_total=24.75, away_implied_total=21.75),
                NFLGame(id="401872940", name="Jacksonville Jaguars at Denver Broncos", date="2026-09-20T20:05Z", venue_name="Empower Field at Mile High", is_dome=False, home_team="DEN", away_team="JAX", over_under=45.5, spread=-2.5, home_implied_total=24.0, away_implied_total=21.5),
                NFLGame(id="401872941", name="Las Vegas Raiders at Los Angeles Chargers", date="2026-09-20T20:05Z", venue_name="SoFi Stadium", is_dome=False, home_team="LAC", away_team="LV", over_under=43.5, spread=-6.5, home_implied_total=25.0, away_implied_total=18.5),
                NFLGame(id="401872944", name="Washington Commanders at Dallas Cowboys", date="2026-09-20T20:25Z", venue_name="AT&T Stadium", is_dome=True, home_team="DAL", away_team="WSH", over_under=50.5, spread=-4.5, home_implied_total=27.5, away_implied_total=23.0),
                NFLGame(id="401872943", name="Seattle Seahawks at Arizona Cardinals", date="2026-09-20T20:25Z", venue_name="State Farm Stadium", is_dome=True, home_team="ARI", away_team="SEA", over_under=40.5, spread=3.5, home_implied_total=18.5, away_implied_total=22.0),
                NFLGame(id="401872942", name="Miami Dolphins at San Francisco 49ers", date="2026-09-20T20:25Z", venue_name="Levi's Stadium", is_dome=False, home_team="SF", away_team="MIA", over_under=44.5, spread=-13.5, home_implied_total=29.0, away_implied_total=15.5),
                NFLGame(id="401872945", name="Indianapolis Colts at Kansas City Chiefs", date="2026-09-21T00:20Z", venue_name="Arrowhead Stadium", is_dome=False, home_team="KC", away_team="IND", over_under=46.5, spread=-6.5, home_implied_total=26.5, away_implied_total=20.0),
                NFLGame(id="401872947", name="New York Giants at Los Angeles Rams", date="2026-09-22T00:15Z", venue_name="SoFi Stadium", is_dome=False, home_team="LAR", away_team="NYG", over_under=47.5, spread=-7.0, home_implied_total=27.25, away_implied_total=20.25),
            ]
        return []
