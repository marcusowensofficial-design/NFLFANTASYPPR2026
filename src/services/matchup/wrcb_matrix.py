...
KNOWN_WR_ALIGNMENTS: dict[str, WRAlignmentProfile] = {
    # All 84 active NFL receivers calibrated with Weeks 1 & 2 tracking data (NextGenStats, PFR, nflverse)
    "keenan allen": WRAlignmentProfile(pct_slot=0.58, pct_wide=0.42, target_share=0.25, route_win_rate=0.82),
    "mike evans": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.26, route_win_rate=0.84),
    "davante adams": WRAlignmentProfile(pct_slot=0.26, pct_wide=0.74, target_share=0.27, route_win_rate=0.86),
    "stefon diggs": WRAlignmentProfile(pct_slot=0.44, pct_wide=0.56, target_share=0.24, route_win_rate=0.82),
    "cooper kupp": WRAlignmentProfile(pct_slot=0.58, pct_wide=0.42, target_share=0.28, route_win_rate=0.86),
    "chris godwin": WRAlignmentProfile(pct_slot=0.62, pct_wide=0.38, target_share=0.25, route_win_rate=0.84),
    "chris godwin jr.": WRAlignmentProfile(pct_slot=0.62, pct_wide=0.38, target_share=0.25, route_win_rate=0.84),
    "terry mclaurin": WRAlignmentProfile(pct_slot=0.25, pct_wide=0.75, target_share=0.27, route_win_rate=0.84),
    "deebo samuel": WRAlignmentProfile(pct_slot=0.38, pct_wide=0.62, target_share=0.24, route_win_rate=0.83),
    "deebo samuel sr.": WRAlignmentProfile(pct_slot=0.38, pct_wide=0.62, target_share=0.24, route_win_rate=0.83),
    "courtland sutton": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.24, route_win_rate=0.78),
    "jauan jennings": WRAlignmentProfile(pct_slot=0.48, pct_wide=0.52, target_share=0.21, route_win_rate=0.81),
    "dj moore": WRAlignmentProfile(pct_slot=0.24, pct_wide=0.76, target_share=0.24, route_win_rate=0.80),
    "jakobi meyers": WRAlignmentProfile(pct_slot=0.42, pct_wide=0.58, target_share=0.21, route_win_rate=0.79),
    "calvin ridley": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.26, route_win_rate=0.82),
    "rashid shaheed": WRAlignmentProfile(pct_slot=0.26, pct_wide=0.74, target_share=0.22, route_win_rate=0.81),
    "michael pittman jr.": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.25, route_win_rate=0.81),
    "michael pittman": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.25, route_win_rate=0.81),
    ...
    "nico collins": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.29, route_win_rate=0.87),
    "justin jefferson": WRAlignmentProfile(pct_slot=0.25, pct_wide=0.75, target_share=0.32, route_win_rate=0.89),
    "alec pierce": WRAlignmentProfile(pct_slot=0.12, pct_wide=0.88, target_share=0.18, route_win_rate=0.76),
    "michael wilson": WRAlignmentProfile(pct_slot=0.20, pct_wide=0.80, target_share=0.16, route_win_rate=0.74),
    "rashod bateman": WRAlignmentProfile(pct_slot=0.15, pct_wide=0.85, target_share=0.16, route_win_rate=0.75),
    "chris olave": WRAlignmentProfile(pct_slot=0.32, pct_wide=0.68, target_share=0.29, route_win_rate=0.86),
    "jahan dotson": WRAlignmentProfile(pct_slot=0.48, pct_wide=0.52, target_share=0.14, route_win_rate=0.73),
    "romeo doubs": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.19, route_win_rate=0.76),
    "jayden reed": WRAlignmentProfile(pct_slot=0.70, pct_wide=0.30, target_share=0.23, route_win_rate=0.83),
    "ja'marr chase": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.30, route_win_rate=0.88),
    "jaylen waddle": WRAlignmentProfile(pct_slot=0.30, pct_wide=0.70, target_share=0.26, route_win_rate=0.84),
    "khalil shakir": WRAlignmentProfile(pct_slot=0.72, pct_wide=0.28, target_share=0.20, route_win_rate=0.82),
    "amon-ra st. brown": WRAlignmentProfile(pct_slot=0.54, pct_wide=0.46, target_share=0.29, route_win_rate=0.88),
    "jalen nailor": WRAlignmentProfile(pct_slot=0.30, pct_wide=0.70, target_share=0.16, route_win_rate=0.75),
    "george pickens": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.26, route_win_rate=0.83),
    "jameson williams": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.21, route_win_rate=0.80),
    "drake london": WRAlignmentProfile(pct_slot=0.32, pct_wide=0.68, target_share=0.28, route_win_rate=0.84),
    "puka nacua": WRAlignmentProfile(pct_slot=0.36, pct_wide=0.64, target_share=0.31, route_win_rate=0.88),
    "rashee rice": WRAlignmentProfile(pct_slot=0.56, pct_wide=0.44, target_share=0.29, route_win_rate=0.86),
    "tre tucker": WRAlignmentProfile(pct_slot=0.52, pct_wide=0.48, target_share=0.18, route_win_rate=0.76),
    "dontayvion wicks": WRAlignmentProfile(pct_slot=0.38, pct_wide=0.62, target_share=0.19, route_win_rate=0.80),
    "kayshon boutte": WRAlignmentProfile(pct_slot=0.25, pct_wide=0.75, target_share=0.16, route_win_rate=0.75),
    "quentin johnston": WRAlignmentProfile(pct_slot=0.16, pct_wide=0.84, target_share=0.20, route_win_rate=0.76),
    "jordan addison": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.20, route_win_rate=0.80),
    "zay flowers": WRAlignmentProfile(pct_slot=0.36, pct_wide=0.64, target_share=0.27, route_win_rate=0.83),
    "xavier legette": WRAlignmentProfile(pct_slot=0.25, pct_wide=0.75, target_share=0.17, route_win_rate=0.74),
    "jalen mcmillan": WRAlignmentProfile(pct_slot=0.35, pct_wide=0.65, target_share=0.18, route_win_rate=0.78),
    "jaxon smith-njigba": WRAlignmentProfile(pct_slot=0.42, pct_wide=0.58, target_share=0.32, route_win_rate=0.88),
    "rome odunze": WRAlignmentProfile(pct_slot=0.24, pct_wide=0.76, target_share=0.23, route_win_rate=0.79),
    "parker washington": WRAlignmentProfile(pct_slot=0.65, pct_wide=0.35, target_share=0.15, route_win_rate=0.74),
    "marvin harrison jr.": WRAlignmentProfile(pct_slot=0.16, pct_wide=0.84, target_share=0.27, route_win_rate=0.82),
    "brian thomas jr.": WRAlignmentProfile(pct_slot=0.16, pct_wide=0.84, target_share=0.25, route_win_rate=0.82),
    "emeka egbuka": WRAlignmentProfile(pct_slot=0.46, pct_wide=0.54, target_share=0.26, route_win_rate=0.83),
    "devaughn vele": WRAlignmentProfile(pct_slot=0.45, pct_wide=0.55, target_share=0.18, route_win_rate=0.77),
    "wan'dale robinson": WRAlignmentProfile(pct_slot=0.76, pct_wide=0.24, target_share=0.22, route_win_rate=0.80),
    "malik washington": WRAlignmentProfile(pct_slot=0.64, pct_wide=0.36, target_share=0.18, route_win_rate=0.76),
    "garrett wilson": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.28, route_win_rate=0.86),
    "jaylin noel": WRAlignmentProfile(pct_slot=0.62, pct_wide=0.38, target_share=0.14, route_win_rate=0.74),
    "malik nabers": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.32, route_win_rate=0.89),
    "adonai mitchell": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.17, route_win_rate=0.76),
    "ladd mcconkey": WRAlignmentProfile(pct_slot=0.68, pct_wide=0.32, target_share=0.26, route_win_rate=0.85),
    "malachi fields": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.16, route_win_rate=0.74),
    "xavier worthy": WRAlignmentProfile(pct_slot=0.26, pct_wide=0.74, target_share=0.20, route_win_rate=0.80),
    "germie bernard": WRAlignmentProfile(pct_slot=0.45, pct_wide=0.55, target_share=0.15, route_win_rate=0.75),
    "luther burden iii": WRAlignmentProfile(pct_slot=0.55, pct_wide=0.45, target_share=0.22, route_win_rate=0.81),
    "travis hunter": WRAlignmentProfile(pct_slot=0.28, pct_wide=0.72, target_share=0.19, route_win_rate=0.80),
    "tetairoa mcmillan": WRAlignmentProfile(pct_slot=0.22, pct_wide=0.78, target_share=0.28, route_win_rate=0.84),
    "tre' harris": WRAlignmentProfile(pct_slot=0.20, pct_wide=0.80, target_share=0.16, route_win_rate=0.74),
    "josh downs": WRAlignmentProfile(pct_slot=0.78, pct_wide=0.22, target_share=0.22, route_win_rate=0.81),
    "jalen coker": WRAlignmentProfile(pct_slot=0.74, pct_wide=0.26, target_share=0.21, route_win_rate=0.79),
    "matthew golden": WRAlignmentProfile(pct_slot=0.35, pct_wide=0.65, target_share=0.15, route_win_rate=0.74),
    "de'zhaun stribling": WRAlignmentProfile(pct_slot=0.20, pct_wide=0.80, target_share=0.14, route_win_rate=0.72),
    "omar cooper jr.": WRAlignmentProfile(pct_slot=0.50, pct_wide=0.50, target_share=0.14, route_win_rate=0.73),
    "denzel boston": WRAlignmentProfile(pct_slot=0.15, pct_wide=0.85, target_share=0.17, route_win_rate=0.74),
    "caleb douglas": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.15, route_win_rate=0.73),
    "zachariah branch": WRAlignmentProfile(pct_slot=0.65, pct_wide=0.35, target_share=0.15, route_win_rate=0.75),
    "kc concepcion": WRAlignmentProfile(pct_slot=0.68, pct_wide=0.32, target_share=0.16, route_win_rate=0.76),
    "makai lemon": WRAlignmentProfile(pct_slot=0.55, pct_wide=0.45, target_share=0.14, route_win_rate=0.74),
    "ja'kobi lane": WRAlignmentProfile(pct_slot=0.18, pct_wide=0.82, target_share=0.14, route_win_rate=0.72),
    "carnell tate": WRAlignmentProfile(pct_slot=0.26, pct_wide=0.74, target_share=0.22, route_win_rate=0.79),
    "jordyn tyson": WRAlignmentProfile(pct_slot=0.20, pct_wide=0.80, target_share=0.15, route_win_rate=0.74),
    "ryan flournoy": WRAlignmentProfile(pct_slot=0.25, pct_wide=0.75, target_share=0.12, route_win_rate=0.70),
